...
pub enum OpCode {
    ...
    /// Madvise operation:
    Madvise(i32) = io_uring_op::IORING_OP_MADVISE as u8,
}
...
impl From<OpCode> for u8 {
    fn from(opcode: OpCode) -> Self {
        match opcode {
            OpCode::Read => io_uring_op::IORING_OP_READ as u8,
            OpCode::Write => io_uring_op::IORING_OP_WRITE as u8,
            OpCode::Fsync => io_uring_op::IORING_OP_FSYNC as u8,
            OpCode::Madvise(_) => io_uring_op::IORING_OP_MADVISE as u8,
        }
    }
}
